          ...
          <div class="box-body table-responsive no-padding">
            ...
            <tr class="{{$produk->kategori}}">
                ...
                <td class="form-group">
                  ...
                  data-target="#exampleModalUbah{{$i}}" onclick="Swal('Data Berhasil DIhapus', 'Latihan' , 'success')">Ubah</button>
                    ...
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        ...
                        <div class="modal-footer">
                          ...
                          <form action="{{route('produk.destroy' , $produk->id_produk)}}" method="post" class="d-inline col-md-1 ">
                        {{csrf_field()}}{{method_field('DELETE')}}
                        <button type="submit" class="btn btn-danger" onclick="Swal.fire('Data Berhasil DIhapus', 'Mantap' , 'success')">Hapus</button>
                      </form>
                        </div>
                      </div>
                    </div>
              ...
              <div class="modal fade" id="exampleModalUbah{{$i}}" tabindex="-1" role="dialog"
                aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-footer">
                      ...
                      <button type="submit" class="btn btn-primary" onclick="Swal('Data Berhasil Diubah', 'Mantap' , 'success')">Ubah</button>
                    </div>
                    </form>
                  </div>
                </div>
